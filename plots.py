...
def los_initial_plot(data_dict, normalize_by_focus=False, print_tex=False):
    ...
    Args:
        ...
        normalize_by_focus: If True, divides final_ub by D_focus
    ...
    if normalize_by_focus:
        ...
        if d_col:
            ...
            df['normalized_ub'] = df['final_ub'] / df[d_col]
            y_col = "normalized_ub"
            y_label = "Avg Length of Stay (Days per Patient)"
...
def sorted_savings_plot(data_dict, workload='heavy', print_tex=False):
    ...
    for i, bar in enumerate(bars):
        ...
        if abs(height) > 0.1: 
             ...
             # Since x-axis now has IDs, let's keep it clean or add value? 
